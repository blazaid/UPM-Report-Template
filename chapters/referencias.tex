...
El índice\index{índice} de un libro\index{libro} es la parte que normalmente está situada al final donde aparece una relación de todos los términos\index{término} relevantes del texto y dónde se encuentran

Para marcar una palabra como índice, basta con añadir tras ella el comando \texttt{\index{término}}. Tras ello, la página de dicha palabra aparecerá referenciada en dicho término en el índice.
