...
\lstinputlisting[language=tex,firstline=11,lastline=13,caption={Configurando autor, título del proyecto y director},label={lst:starting-title-author-and-director}]{report.tex}
...
Existe la opción de añadir agradecimientos con \lstinline{\acknowledgements}. Si no se pone no se renderiza en el documento final, pero es algo bonito y a las abuelas les encanta aparecer ahí. Y las abuelas son de lo más bonito que existe en este mundo, así que cuidadlas.
...
\lstinputlisting[language=tex,firstline=37,lastline=40,caption={Cómo incluir capítulos y apéndices},label={lst:starting-include-chapters}]{report.tex}
